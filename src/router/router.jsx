...
import CourseCatalogPage, { CourseCatalogErrorPage } from "../pages/course-catalog/CourseCatalogPage.jsx";
...
export const router = createBrowserRouter([
  ...
  { path: "/auth", loader: requireAnonLoader, element: <AuthPage /> },
  {
    ...
    children: [
      ...
      { path: "/course-catalog", loader: courseCatalogLoader, element: <CourseCatalogPage />, errorElement: <CourseCatalogErrorPage /> },
      {
